...
export function registerSolutionExplorerCommands(context: vscode.ExtensionContext, provider: SolutionExplorerProvider): void {
    ...
    register('dotnet-studio.solutionExplorer.refresh', () => provider.refresh(undefined));
    register('dotnet-studio.solutionExplorer.newFile', newFile);
    register('dotnet-studio.solutionExplorer.newClass', newClass);
    register('dotnet-studio.solutionExplorer.newFolder', newFolder);
    register('dotnet-studio.solutionExplorer.addExistingFile', addExistingFile);
    register('dotnet-studio.solutionExplorer.rename', rename);
    register('dotnet-studio.solutionExplorer.delete', deleteNodes);
    register('dotnet-studio.solutionExplorer.copy', copy);
    register('dotnet-studio.solutionExplorer.cut', cut);
    register('dotnet-studio.solutionExplorer.paste', paste);
    register('dotnet-studio.solutionExplorer.copyPath', copyPath);
    register('dotnet-studio.solutionExplorer.copyRelativePath', copyRelativePath);
    register('dotnet-studio.solutionExplorer.exclude', (node: FileNode) => excludeCommand(node, provider));
    register('dotnet-studio.solutionExplorer.include', (node: FileNode) => includeCommand(node, provider));
    register('dotnet-studio.solutionExplorer.revealInFileExplorer', revealInFileExplorer);
    register('dotnet-studio.solutionExplorer.openInIntegratedTerminal', openInIntegratedTerminal);
    register('dotnet-studio.solutionExplorer.editProjectFile', editProjectFile);
    register('dotnet-studio.solutionExplorer.editSolutionFile', editSolutionFile);
    register('dotnet-studio.solutionExplorer.removeFromSolution', (node: ProjectNode) => removeFromSolution(node, provider));
    register('dotnet-studio.solutionExplorer.unloadProject', (node: ProjectNode) => unloadProject(node, provider));
    register('dotnet-studio.solutionExplorer.reloadProject', (node: ProjectNode) => reloadProject(node, provider));
    register('dotnet-studio.solutionExplorer.manageProjectReferences', (node: DependenciesNode) => manageProjectReferences(node, provider));
    register('dotnet-studio.solutionExplorer.setAsStartupProject', setAsStartupProject);
    register('dotnet-studio.solutionExplorer.build', (node: ProjectNode | SolutionNode) => buildTarget(node, 'build'));
    register('dotnet-studio.solutionExplorer.rebuild', (node: ProjectNode | SolutionNode) => buildTarget(node, 'rebuild'));
    register('dotnet-studio.solutionExplorer.clean', (node: ProjectNode | SolutionNode) => buildTarget(node, 'clean'));
    register('dotnet-studio.solutionExplorer.run', runTarget);
    register('dotnet-studio.solutionExplorer.openNugetManager', (node: ProjectNode | DependenciesNode | PackageNode) => openNugetManager(node, context));
    register('dotnet-studio.solutionExplorer.publish', (node: ProjectNode) => openPublishPanel(node, context));
}
